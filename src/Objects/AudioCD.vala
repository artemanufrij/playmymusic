    ...
    public class AudioCD : TracksContainer {
        ...
        public string mb_disc_id {
            get {
                ...
                _mb_disc_id = value;
                this.cover_path = GLib.Path.build_filename (PlayMyMusicApp.instance.COVER_FOLDER, ("audio_cd_%s.jpg").printf (this.mb_disc_id));
                this.background_path = GLib.Path.build_filename (PlayMyMusicApp.instance.COVER_FOLDER, ("audio_cd_%s_background.png").printf (this.mb_disc_id));
        ...
        public void create_track_list () {
            ...
            file.query_info_async.begin (
                string.joinv (",", attributes),
